...
def count_x_eye(R, theta, phi):
    return R * math.cos(theta * math.pi / 180) * math.cos(phi * math.pi / 180)


def count_y_eye(R, phi):
    return R * math.sin(phi * math.pi / 180)


def count_z_eye(R, theta, phi):
...
def render(time):
    ...
    gluLookAt(count_x_eye(R, theta, phi), count_y_eye(R, phi), count_z_eye(R, theta, phi),
